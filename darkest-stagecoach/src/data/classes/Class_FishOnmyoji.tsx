...
import portrait from '../../assets/img/portraits/fish_onmyoji_portrait_roster.png'

export const Class_FishOnmyoji: ClassMod = {
    name: 'FishOnmyoji',
    portrait: portrait,
    religious: false,
    resistances: {stun: 0.2, blight: 0.25, bleed: 0.3, disease: 0.3, move: 0.25, debuff: 0.4, deathBlow: 0.67, trap: 0.1},
    stats: {
        armours: [
