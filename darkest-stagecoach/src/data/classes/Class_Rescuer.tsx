...
import portrait from '../../assets/img/portraits/rescuer_portrait_roster.png'

export const Class_Rescuer: ClassMod = {
    name: 'Rescuer',
    portrait: portrait,
    religious: false,
    resistances: {stun: 0.4, blight: 0.4, bleed: 0.4, disease: 0.2, move: 0.2, debuff: 0.3, deathBlow: 0.67, trap: 0.1},
    stats: {
        armours: [
