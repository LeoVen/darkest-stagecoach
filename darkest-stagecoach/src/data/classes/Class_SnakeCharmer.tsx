...
import portrait from '../../assets/img/portraits/snake_charmer_portrait_roster.png'

export const Class_SnakeCharmer: ClassMod = {
    name: 'SnakeCharmer',
    portrait: portrait,
    religious: false,
    resistances: {stun: 0.3, blight: 0.5, bleed: 0.3, disease: 0.3, move: 0.3, debuff: 0.3, deathBlow: 0.67, trap: 0.2},
    stats: {
        armours: [
