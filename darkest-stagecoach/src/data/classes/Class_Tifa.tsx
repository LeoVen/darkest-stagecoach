...
import portrait from '../../assets/img/portraits/tifa_portrait_roster.png'

export const Class_Tifa: ClassMod = {
    name: 'Tifa',
    portrait: portrait,
    religious: false,
    resistances: {stun: 0.3, blight: 0.4, bleed: 0.2, disease: 0.3, move: 0.2, debuff: 0.4, deathBlow: 0.67, trap: 0.4},
    stats: {
        armours: [
