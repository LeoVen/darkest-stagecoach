...
import portrait from '../../assets/img/portraits/commissar_portrait_roster.png'

export const Class_Commissar: ClassMod = {
    name: 'Commissar',
    portrait: portrait,
    religious: false,
    resistances: {stun: 0.4, blight: 0.4, bleed: 0.4, disease: 0.3, move: 0.4, debuff: 0.3, deathBlow: 0.67, trap: 0.1},
    stats: {
        armours: [
