...
import portrait from '../../assets/img/portraits/exorcist_portrait_roster.png'

export const Class_Exorcist: ClassMod = {
    name: 'Exorcist',
    portrait: portrait,
    religious: false,
    resistances: {stun: 0.5, blight: 0.1, bleed: 0.3, disease: 0.3, move: 0.4, debuff: 0.3, deathBlow: 0.67, trap: 0.1},
    stats: {
        armours: [
