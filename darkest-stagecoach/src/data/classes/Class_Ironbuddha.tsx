...
import portrait from '../../assets/img/portraits/ironbuddha_portrait_roster.png'

export const Class_Ironbuddha: ClassMod = {
    name: 'Ironbuddha',
    portrait: portrait,
    religious: false,
    resistances: {stun: 0.5, blight: 0.2, bleed: 0.4, disease: 0.3, move: 0.5, debuff: 0.4, deathBlow: 0.67, trap: 0.2},
    stats: {
        armours: [
