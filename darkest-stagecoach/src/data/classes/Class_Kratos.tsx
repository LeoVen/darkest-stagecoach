...
import portrait from '../../assets/img/portraits/kratos_portrait_roster.png'

export const Class_Kratos: ClassMod = {
    name: 'Kratos',
    portrait: portrait,
    religious: false,
    resistances: {stun: 0.5, blight: 0.2, bleed: 0.2, disease: 0.3, move: 0.5, debuff: 0.3, deathBlow: 0.67, trap: 0.1},
    stats: {
        armours: [
