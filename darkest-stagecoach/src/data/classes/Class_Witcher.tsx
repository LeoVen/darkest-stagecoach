...
import portrait from '../../assets/img/portraits/witcher_portrait_roster.png'

export const Class_Witcher: ClassMod = {
    name: 'Witcher',
    portrait: portrait,
    religious: false,
    resistances: {stun: 0.4, blight: 0.8, bleed: 0.3, disease: 3, move: 0.4, debuff: 0.6, deathBlow: 0.75, trap: 0.5},
    stats: {
        armours: [
